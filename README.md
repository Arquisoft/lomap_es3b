...
[![CI for LOMAP ES3B](https://github.com/Arquisoft/lomap_es3b/actions/workflows/lomap_es3b.yml/badge.svg)](https://github.com/Arquisoft/lomap_es3b/actions/workflows/lomap_es3b.yml)
...
If you want to execute the project you will need [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) and [Docker](https://docs.docker.com/get-docker/). Make sure the three of them are installed in your system. Download the project with `git clone https://github.com/arquisoft/lomap_es3b`. The fastest way to launch everything is with docker:
```bash
...
- Documentation: https://github.com/arquisoft/lomap_es3b/tree/master/docs
- Webapp: https://github.com/arquisoft/lomap_es3b/tree/master/webapp
- Restapi: https://github.com/arquisoft/lomap_es3b/tree/master/restapi
