...
Si quieres ejecutar el proyecto necesitarás [git](https://git-scm.com/downloads), [Node.js and npm](https://www.npmjs.com/get-npm) y [Docker](https://docs.docker.com/get-docker/). Asegúrate de tenerlos instalados en tu equipo. Descarga el proyecto con `git clone https://github.com/arquisoft/lomap_es3b`. La manera más rápida de ejecutar todo es con Docker.
...
- Documentación: https://github.com/arquisoft/lomap_es3b/tree/master/docs
