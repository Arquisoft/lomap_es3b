...
la url en la que se despliega es: [https://arquisoft.github.io/lomap_es3b/](https://arquisoft.github.io/lomap_es3b/).
...
Si queremos desplegar la documentación en GitHub pages, estará accesible en [https://arquisoft.github.io/lomap_es3b/](https://arquisoft.github.io/lomap_es3b/) necesitamos ejecutar `npm run deploy`.
